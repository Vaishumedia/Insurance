      ...
      <div id="footercont">
        <div id="footerchild">
          ...
          <div id="tc">
            ...
            <p>
              *The Guaranteed Returns are dependent on the policy term and
              premium term availed along with the other variable factors. 7.5%
              rate of return is for a 18 years old, healthy male for a policy
              term of 10 years and premium term of 5 years with Rs.20,000
              monthly instalment premium. STANDARD TERMS AND CONDITIONS APPLY.
      ...
      <div id="footercont">
        ...
        <div id="tc" style={{ textAlign: "center", color: "#585858" }}>
          ...
          <p>
            ...
            44, Gurgaon, Haryana - 122001 Tel no. : 0124-4218302 Email ID:
            enquiry@policybazaar.com
          </p>
          <p>Contact Us | Legal and Admin Policies</p>
          <p>
            Policybazaar is registered as a Direct Broker | Registration No.
            742, Registration Code No. IRDA/ DB 797/ 19, Valid till 09/06/2024,
            License category- Direct Broker (Life & General)| Visitors are
            hereby informed that their{" "}
          </p>
          <p>
            information submitted on the website may be shared with
